...
URL_VERSION="https://raw.githubusercontent.com/cachenow/hassio-installer/master/stable.json"
...
docker tag "$HASSIO_DOCKER:$HASSIO_VERSION" "$HASSIO_DOCKER:0.91.4" > /dev/null
